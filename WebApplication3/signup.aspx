...
<body>
    ...
    <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 75px; top: 88px; position: absolute" Text="id"></asp:Label>
     ...
     <asp:Label ID="Label10" runat="server" style="z-index: 1; left: 75px; top: 458px; position: absolute" Text="Phone"></asp:Label>
        ...
        <asp:Button ID="Button1" runat="server" style="z-index: 1; left: 139px; top: 555px; position: absolute" Text="Submit" OnClick="Button1_Click" />
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/signin.aspx" style="z-index: 1; left: 200px; top: 555px; position: absolute">Sign In</asp:HyperLink>
